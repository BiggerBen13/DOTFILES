...
M = {
  ...
  s({ trig = 'tab', name = "table", desr = 'Table environment' },
    fmta(
      [[
      \begin{tabular}{<>}
      <>
  ...
  autosnippet({ trig = '---', wordTrig = false, name = "hline" }, { t("\\hline") },
    { condition = tex.in_table * line_begin }),

  autosnippet({ trig = "\\b(jf|fj)", wordTrig = false, regTrig = true, name = "new Coloumn", trigEngine = "ecma" }, { t("&") },
    { condition = tex.in_table }),

  autosnippet({ trig = "\\b(kj|jk)", wordTrig = false, regTrig = true, name = "new Row", trigEngine = "ecma" }, { t({"\\\\", ""}) },
    { condition = tex.in_table }),
}
